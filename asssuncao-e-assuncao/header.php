...
<div class="home page_home center m_bottom_15" style="background:<?php echo vp_option('header_color'); ?> url(<?php 
        ...
        <div class="container"> 
            ...
            <div class="logo" style="width:100%; max-width:455px; margin: 0 auto; margin-bottom:55px;">
                <?php if( vp_option('logo') != ''){ ?>
                	<?php if( is_front_page() ) : ?>
				<a href="<?php echo get_bloginfo ( 'url' ); ?>"><img src="<?php echo vp_option('logo'); ?>" alt="logo" width="100%" /></a> 
			<?php else : ?>
				<a href="<?php echo get_bloginfo ( 'url' ); ?>"><img src="http://assuncaoeassuncao.adv.br/wp-content/uploads/2014/04/logo-50.png" alt="logo" /></a> 
			<?php endif; ?>
				<?php } ?>
            </div>
