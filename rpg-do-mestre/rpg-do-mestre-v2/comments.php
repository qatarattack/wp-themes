...
<div id="respond">
    ...
    <div class="cancel-comment-reply"><?php cancel_comment_reply_link( 'Cancelar resposta' ); ?></div>
    
    <h3 id="leave-a-reply"><?php comment_form_title( 'Deixe uma resposta', 'Deixe uma resposta para %s' ); ?></h3> 
    
    <?php if ( get_option( 'comment_registration' ) && !is_user_logged_in() ) : ?>
	<p id="login-req" class="alert">Você deve estar<a href="<?php echo get_option( 'siteurl' ); ?>/wp-login.php?redirect_to=<?php echo urlencode( get_permalink() ); ?>">logado</a> para posta um comentário.</p>
    <?php else : ?>
	...
	<form id="comment-form" method="post" action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php">
        ...
        <p>Logado como <a href="<?php echo get_option( 'siteurl' ); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url( get_permalink() ); ?>" title="Faça logoff dessa conta">Fazer logout &raquo;</a></p>
        ...
        <div id="form-section-author" class="form-section">
            ...
            <label for="author"<?php if ( $req ) echo ' class="required"'; ?>>Nome</label>
        ...
        <div id="form-section-actions" class="form-section">
			<button name="submit" id="submit" type="submit" tabindex="5">Enviar coment&aacute;rio</button>
