	    	...
	    	<a name="comment-<?php comment_ID() ?>"></a>
	      	...
	      	<article id="li-comment-<?php comment_ID() ?>" class="comment-container">
				...
				<?php if( get_comment_type() == 'comment' ) { ?>
	                <div class="avatar"><?php the_commenter_avatar( 60 ); ?></div>
	            <?php } ?>            
		   		...
		   		<header class="comment-head">
	                ...
	                <span class="perma"><a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this comment', 'woothemes' ); ?>">#<?php comment_ID(); ?></a></span>
